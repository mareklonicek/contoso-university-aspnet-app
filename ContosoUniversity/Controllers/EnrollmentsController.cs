...
namespace ContosoUniversity.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.StudentID = new SelectList(_context.Students, "ID", "ID");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseID,StudentID,Grade")] Enrollment enrollment)
        {
            ...
            ViewBag.CourseID = new SelectList(_context.Courses, "CourseID", "CourseID", enrollment.CourseID);
            ViewBag.StudentID = new SelectList(_context.Students, "ID", "ID", enrollment.StudentID);
            return View(enrollment);
        }
